...
export default class Renderer {
  ...
  setPostProcess() {
    ...
    if (this.debug) {
      this.debugFolder.add(this.postProcess.unrealBloomPass, "enabled");
      this.debugFolder.add(this.postProcess.unrealBloomPass, "strength", 0, 3);
      this.debugFolder.add(this.postProcess.unrealBloomPass, "radius", 0, 1);
      this.debugFolder.add(this.postProcess.unrealBloomPass, "threshold", 0, 1);
    }
